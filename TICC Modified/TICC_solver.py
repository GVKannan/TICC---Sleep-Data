...
class TICC:
    ...
    def fit(self, input_file):
        ...
        self.log_parameters()
        print("Checked for the maximum no. of iteration is not zero")
        ...
        print("Training data split done")
        ...
        for iters in range(self.maxIters):
            ...
            for point, cluster_num in enumerate(clustered_points):
                ...
                #print("Cluster Array no: ",cluster_num, " intiated")
        ...
        print("BIC: ",bic ," for Cluster:",self.number_of_clusters," Lambda: ",self.lambda_parameter," Beta: ",self.switch_penalty )
        return clustered_points, train_cluster_inverse, bic

    def compute_f_score(self, matching_EM, matching_GMM, matching_Kmeans, train_confusion_matrix_EM,
                        train_confusion_matrix_GMM, train_confusion_matrix_kmeans):
        #print("compute_f_score() invoked")
        ...
        #print("EM Corrected: ", correct_e_m)
        #print("GMM Corrected: ", correct_g_m_m)
        #print("")
        #print("Corrected EM, GMM and K-means calculated")
        #print("compute_f_score() returned")
         
    def compute_matches(self, train_confusion_matrix_EM, train_confusion_matrix_GMM, train_confusion_matrix_kmeans):
        #print("compute_matches() invoked")
    ...
    def smoothen_clusters(self, cluster_mean_info, computed_covariance,
        ...
        print("Smoothening Algorithm using smot")
        #print("smoothen_cluster() returned")
    ...
    def optimize_clusters(self, computed_covariance, len_train_clusters, log_det_values, optRes, train_cluster_inverse):
        #print("optimize_clusters() invoked")
        print("Number of Clusters: ", self.number_of_clusters)
        for cluster in range(self.number_of_clusters):
            if optRes[cluster] == None:
                continue
            #print("opRes: ",optRes[cluster])
            #print("opRes: ",optRes[cluster].get())
            print("Value of Clusters: ",self.number_of_clusters, " Value of Lambda: ",self.lambda_parameter," Beta value: ",self.switch_penalty )
            try:
            ...
            ## 23.05.2018: Add a return statement value as NaN
            #print("val: ",val)
            ...
            try:
                ...
                print("Array contains infs or NaNs, skipping data point!")
                time.sleep(2)
                continue
        ...
        print("optimize_clusters() returned")
    ...
    def train_clusters(self, cluster_mean_info, cluster_mean_stacked_info, complete_D_train, empirical_covariances,
        ...
        for cluster in range(self.number_of_clusters):
            ...
            if cluster_length != 0:
                ...
                #print("Fitting and Optimizing Model in train_clusters()")
    ...
    def stack_training_data(self, Data, n, num_train_points, training_indices):
        ...
        #print("stack_training_data() returned")
        return complete_D_train

    def prepare_out_directory(self):
        #print("prepare_out_directory() invoked. ")
        ...
        if not os.path.exists(os.path.dirname(str_NULL)):
            try:
                ...
                if exc.errno != errno.EEXIST:
                    raise
        #print("prepare_out_directory() returned")
        return str_NULL

    def load_data(self, input_file):
        #print("load_data() invoked")
        Data = np.loadtxt(input_file, delimiter=",")
        (m, n) = Data.shape  # m: num of observations, n: size of observation vector
        #print("completed getting the data")
        #print("load_data() returned")
        return Data, m, n

    def log_parameters(self):
        print("log_parameters() invoked")
    ...
    def predict_clusters(self, test_data = None):
        ...
        '''
        print("predict_clusters() invoked!\n")
        ...
        print("Updating and Returning Clustered Points using new smoothening.")
